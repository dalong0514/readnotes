...
1『这里实现「私有属性」的知识点很重要，「JS 精粹」里也有提到，但目前还没吃透。（2020-05-29）』
...
上面代码是开发数据流时遇到的问题，关键点在用箭头函数后 this 可以绑定到外层词法环境的 this 值，这里即全局变量，否者得使用「var that = this」语句。实在太赞了，解决之前很大的一个困惑。（2020-05-19）
