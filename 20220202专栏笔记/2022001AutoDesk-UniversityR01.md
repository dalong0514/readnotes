...
1 Discover the AutoCAD .NET API.

2 Learn how to create a command using AutoCAD software's .NET API.

3 Discover general coding best practices with AutoCAD software's .NET API.

4 Learn how to load an AutoCAD plug-in created using AutoCAD software's .NET API.
