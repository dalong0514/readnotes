...
const getCurrentTime = () => new Date(); const clear = () => console.clear();
...
const display = target => time => target(time); const formatClock = format => time =>
