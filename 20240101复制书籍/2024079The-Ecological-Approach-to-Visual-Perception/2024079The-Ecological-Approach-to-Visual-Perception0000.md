...
这本书首次出版于 1979 年，内容讲述了我们是如何看见的：包括我们周围的环境（包括其表面、布局、颜色和纹理）；我们在环境中的位置；我们是否在移动，如果在移动，我们去向哪里；物品的用途；如何做事情（例如穿针或驾驶汽车）；以及为什么事物看起来是这样的。

基本假设是视觉依赖于连接到大脑的眼睛。作者认为自然视觉依赖于头部中的眼睛，而身体由地面支撑，大脑只是完整视觉系统的中央器官。在没有对视觉系统进行限制的情况下，人们会四处张望，走向某个有趣的东西，并绕着它移动以便从各个角度观察它，然后再从一个景色走向另一个景色。这就是自然视觉 —— 也是本书的主题。

James J. Gibson（1904-1979）是 20 世纪最重要的心理学家之一，因其在视觉感知方面的工作而闻名。他获得了普林斯顿大学的博士学位，他的第一部主要作品是《视觉世界的感知》(1950)，在这部作品中，他拒绝了行为主义，转而基于自己的实验工作提出了新的观点。

在他的后期作品中，包括《视觉感知的生态学方法》(1979)，Gibson 变得更加哲学化，并以类似于他之前批评行为主义的方式批评了认知主义，强烈主张直接感知和直接现实主义，而不是认知主义的间接现实主义。他称其新方法为「生态心理学」。

Gibson 的遗产对许多当代心理学运动，特别是那些被认为是后认知主义的运动，产生了越来越大的影响。
