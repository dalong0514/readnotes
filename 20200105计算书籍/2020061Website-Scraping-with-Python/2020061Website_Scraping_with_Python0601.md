...
1 [Scrapy Cloud - The Most Advanced Platform for Running Web Crawlers](https://scrapinghub.com/scrapy-cloud)
...
This tells ScrapingHub that you want to use Scrapy version 1.5 running in a Python 3 environment.
