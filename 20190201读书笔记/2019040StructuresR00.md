...
### 0402. 金句卡 —— 结构的失效是可控的，它靠的不是强度，而是材料的脆度
...
### 0509. 信息数据卡 —— 破坏任一平面或截面的所有化学键的所需的总能量
