...
请结合本书内容提炼一张标题为「ARIZ」的术语卡，至少列举出 3 个例子。请先重新阐述任务。

标题：ARIZ

定义：ARIZ（Algorithm of Inventive Problem Solving）是一种创新问题解决的算法，由创新理论（TRIZ）的创始人 Genrich Altshuller 开发。ARIZ 提供了一种结构化的方法来引导发明者找到他们问题的最强大的解决方案。
