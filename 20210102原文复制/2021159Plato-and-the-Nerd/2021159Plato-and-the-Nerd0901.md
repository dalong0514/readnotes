...
模型是相似的，它们都基于某种形式语言来表达。作为一名工程师，我需要模型是可以被理解的，同时，我还需要和我所构建的模型高度相符的物理系统。我不需要我的模型是真实的。例如，我们都知道，我们可以制造一个很好的气球机器，即使周长永远不会是 π

×d

。另外，我们也可以制造出一个相当好的电感，即使法拉第定律无法精确地描述它的行为。
