...
### 5. Navigating Through the Product Listings
...
Because item exporters are similar to item pipelines, they process only one item at a time, we have to be tricky and save the items in memory just like for the CsvItemPipeline class. Basically, we will reuse the already written code and rename some methods.
...
Figure 4-3. Images downloaded when Scrapy run
...
## 09. Using Beautiful Soup with Scrapy
...
## 11. (A Bit) Advanced Configuration
